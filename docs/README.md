...
| [Tools Reference](tools/) | Complete API reference for all 50 MCP tools |
...
├── tools/
│   ├── reference.md         # All 50 tools with parameters
...
### The 50 Tools
OrcaMCP provides 50 tools across these categories:
