...
FULL_TOOLS_LIST = [{'description': 'Create or overwrite a physical printer (print host) and '
                 'select it.',
                  ...
                  'properties': {'api_key': {'description': 'API key, or the '
                                 ...
                                 'host_type': {'description': 'Print host type',
                                               'enum': ['flashforge',
                                                        ...
                                                        'crealityprint'],
                                               'type': 'string'},
                                 'name': {'description': 'Physical printer '
                                                         'name, e.g. "C5P"',
                                          'type': 'string'},
 ...
 {'description': 'Select a printer, filament, or print preset by name',
  'inputSchema': {'additionalProperties': False,
                  ...
                  'type': 'object'},
  'name': 'select_preset'},
 {'description': 'Select a printer: a Bambu device by dev_id, or a physical '
                 'printer (print host) by name.',
  'inputSchema': {'additionalProperties': False,
                  'properties': {'dev_id': {'description': 'Bambu device ID',
                                            'type': 'string'},
                                 'physical_printer': {'description': 'Physical '
                                                                     'printer '
                                                                     'name as '
                                                                     'listed '
                                                                     'by '
