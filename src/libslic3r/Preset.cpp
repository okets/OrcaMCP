...
static std::vector<std::string> s_Preset_printer_options {
    ...
    "host_type", "print_host", "printhost_apikey", "flashforge_serial_number", "flashforge_obico_url", "flashforge_obico_token", "bbl_use_printhost", "printer_agent",
    "print_host_webui",
