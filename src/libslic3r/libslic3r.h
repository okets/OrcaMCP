...
#define SLIC3R_APP_FULL_NAME "OrcaMCP"
#define GCODEVIEWER_APP_NAME "OrcaMCP G-code Viewer"
#define GCODEVIEWER_APP_KEY  "OrcaMCPGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("OrcaMCP G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
