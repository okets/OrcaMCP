        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE)
{
    ...
    text_list.push_back(_L("Created by Hanan Vaknin, OrcaMCP is a fork of Orca Slicer with one purpose: to let AI agents drive the slicer. Everything that previously needed a person at the mouse — loading and arranging models, painting supports and colour, slicing, sending to a printer — is reachable through an MCP endpoint, and an agent can see what it is doing through rendered views and machine vision instead of working blind."));
    ...
    wxStaticText *html_text = new wxStaticText(this, wxID_ANY, "Copyright(C) 2026 OrcaMCP. Based on Orca Slicer, "
                                                  "Copyright(C) 2026 OrcaSlicer Pte Ltd All Rights Reserved.", wxDefaultPosition, wxDefaultSize);
